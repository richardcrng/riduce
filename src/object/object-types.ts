...
export type ObjectCreators<LeafT extends {} = {}, TtreeT = unknown> = {
...
export type ObjectActions<KeyT extends keyof ObjectCreators, LeafT = unknown, TreeT = unknown> = ReturnType<
  ObjectCreators<LeafT, TreeT>[KeyT]
>;
...
export function isPushedSetValueAction<L>(action: Action): action is ReturnType<PushedSetWithValue<L>> {
  return isPushedSetAction(action) && typeof action.payload !== 'function';
}
