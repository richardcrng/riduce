...
export type CreateAPI<LeafT, TreeT, RiducerDictT extends RiducerDict<TreeT>> = DefaultCreators<
  LeafT,
  TreeT,
  RiducerDictT
> &
...
export type TypedCreators<LeafT, TreeT> = LeafT extends unknown[]
...
export type DefaultCreators<LeafT, TreeT, RiducerDictT extends RiducerDict<TreeT>> = UniversalCreators<LeafT, TreeT> &
